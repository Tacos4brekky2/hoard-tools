...
const (
	ComputeService_FunctionName_FullMethodName = "/ComputeService/FunctionName"
)
...
type ComputeServiceClient interface {
	FunctionName(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *computeServiceClient) FunctionName(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
	err := c.cc.Invoke(ctx, ComputeService_FunctionName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ComputeServiceServer interface {
	FunctionName(context.Context, *Message) (*Message, error)
...
func (UnimplementedComputeServiceServer) FunctionName(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FunctionName not implemented")
}
...
func _ComputeService_FunctionName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ComputeServiceServer).FunctionName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ComputeService_FunctionName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ComputeServiceServer).FunctionName(ctx, req.(*Message))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ComputeService_FunctionName_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "hoard-compute.proto",
}
