...
const (
	RemoteService_FunctionName_FullMethodName = "/RemoteService/FunctionName"
)
...
func (c *remoteServiceClient) FunctionName(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Message)
	err := c.cc.Invoke(ctx, RemoteService_FunctionName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRemoteServiceServer) FunctionName(context.Context, *Message) (*Message, error) {
...
func _RemoteService_FunctionName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RemoteServiceServer).FunctionName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RemoteService_FunctionName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteServiceServer).FunctionName(ctx, req.(*Message))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RemoteService_FunctionName_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "hoard-remote.proto",
}
